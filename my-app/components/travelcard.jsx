  ...
  return (
    <div className="flex flex-col items-center text-center max-w-xl w-full gap-3">
      ...
      <h2 className="font-light text-4xl md:text-5xl leading-tight text-stone-100 mb-3">
        How far did you travel <em className="italic text-orange-200">this year </em>?
      </h2>
      ...
      <div className="text-6xl font-light text-orange-200 leading-none mb-1">
        {displayMiles}
      </div>
      <p className="text-xs tracking-widest uppercase text-orange-200 mb-5">
        miles this year
      </p>
