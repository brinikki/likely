export default function IntroScreen({ onStart }) {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center gap-10 px-8">
            ...
            <h1 className="font-light text-5xl md:text-7xl leading-tight text-stone-100 mb-5 max-w-2xl">What are the odds you'd be {''} <em className="italic text-amber-400">you</em>
            <br />right now?</h1>
